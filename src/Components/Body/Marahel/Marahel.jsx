  ...
  return (
    <>
      ...
      <div className={Marahelcss.desing}>
        ...
        <p>در این مرحله ما نسخه اولیه از مطالب خواسته شده را در اختیار شما قرار می‌دهیم تا از روند انجام پروژه مطلع باشید.</p>
        </div>
        <div id={Marahelcss.levels2}>
        <img src={aks3}></img>
        <h2>ارائه نسخه اولیه</h2>
        <p>بعد از تکمیل پروژه یک فایل تست در اختیار شما قرار می‌گیرد تا به بررسی پروژه بپردازید و در صورت مشکل به ما اطلاع بدهید تا تیم اُ یک به بررسی مشکل ایجاد شده بپردازد.
</p>
        </div>
      </div>
    </>
